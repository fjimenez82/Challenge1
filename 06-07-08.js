  ...
  class Viajero {
    constructor(nombre, edad, paises, compañeros) {
      ...
      return {
          ...
          edad: this.edad,
          paises: this.paises,
          compañeros: this.compañeros
          }
       } 

       this.nombres = function() {
        let nombre = [];
        for(i=0; i<this.compañeros.lentgth; i++){
          nombre[i] = compañeros[i].nombre;
        }
        return  nombre         
       } 

       this.paises_f = function() {
        return  this.paises         
       }
       ...
       this.promedio = function() {
        ...
        let suma=0;
        for(i=0; i<this.compañeros.lentgth; i++){
          suma = compañeros[i].edad + suma;
        }
        return  suma/this.compañeros.lentgth        
       } 
    }
